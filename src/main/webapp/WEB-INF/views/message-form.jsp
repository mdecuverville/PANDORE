...
<div id="container">
    ...
    <div id="body">
        <div >
            <h3>Save Message</h3>
            <form:form action="save" modelAttribute="message" method="post" >
                <table>
                    <tbody>
                    <form:hidden path="id" />
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><form:textarea name="name" path="content"/></td>
                    </tr>
                    <tr>
                        <td><label for="content"> message :</label></td>
                        <%--<td>--%>
            ...
            <p>
                <a href="${pageContext.request.contextPath}/message/list">Back to list</a>
            </p>
